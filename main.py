...
for month in range(month_start, month_end + 1):
    for day in range(1 , 32):
        print('Month %d  Day %d' %(month, day))
        url = 'http://www.scorecenterlive.com/ko/sports-livescore.html?sports=bs&nation=ko&date=2018-'+utils.numtoten(month)+'-'+utils.numtoten(day)
